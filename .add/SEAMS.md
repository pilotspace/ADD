...
Anchor: `add-method/tooling/add.py:5711` (`_declared_scope`)   <!-- re-pinned 2026-07-14 status-ancestor-warn: 5688→5711 (cmd_status grew _ancestor_note + its call above it; the pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes; todo #30 seams-symbol-pins retires this class) -->
