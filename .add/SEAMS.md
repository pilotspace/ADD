...
Anchor: `add-method/tooling/add.py:4434` (`_declared_scope`)   <!-- re-pinned 2026-07-19 atomic-node: 4544→4434 (lane scaffolds + strip machinery removed upstream); the pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes; todo #30 seams-symbol-pins retires this class. prior: 6085→4544 @ engine-kernel-trim -->
