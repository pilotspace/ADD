...
Anchor: `add-method/tooling/add.py:5631` (`_declared_scope`)   <!-- re-pinned 2026-07-14 phase-merge-specify: 5619→5631 (the _touches_paths helper above it — the pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes; todo #30 seams-symbol-pins retires this class) -->
