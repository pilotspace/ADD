...
Anchor: `add-method/tooling/add.py:4892` (`_declared_scope`)   <!-- re-pinned 2026-07-07 x5: 4756→4766→4786→4798→4870→4892 (engine growth above — the line pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes) -->
