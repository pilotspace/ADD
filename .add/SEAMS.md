...
Anchor: `add-method/tooling/add.py:5562` (`_declared_scope`)   <!-- re-pinned 2026-07-13 scope-echo-draft: 5526→5562 (_scope_echo inserted above cmd_freeze — the pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes; todo #30 seams-symbol-pins retires this class) -->
