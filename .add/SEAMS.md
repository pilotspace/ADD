...
Anchor: `add-method/tooling/add.py:4796` (`_declared_scope`)   <!-- re-pinned 2026-07-20 graph-views: 4710→4796 (cmd_graph added upstream); the pin drifts on ANY upstream add.py change; symbol cited so the drift self-describes; todo #30 seams-symbol-pins retires this class. prior: 6085→4544 @ engine-kernel-trim -->
