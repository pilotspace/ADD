...
════════════════════════════════════════════════════════════════════════
 ...
 goal  the observe→deltas→fold→compact loop actually converges —
       ...
       surfaces compaction debt + the carried backlog instead of letting
       them rot silently, and the self-improving loop is readable as ONE
       surface across the 5 domains
