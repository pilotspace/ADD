...
test_cmd: python3 -m pytest add-method/tests/engine/test_refute_gate_rung.py -q --junitxml=/var/folders/1j/dpmnj2ns0l9b36b65zjktclc0000gn/T//add-run.xml
---
...
- [Evidence over tests — trust on independent evidence against frozen intent](milestones/evidence-over-tests.md) — `direction`
...
- [dogfood evidence-over-tests on real work and decide whether a bench is warranted](tasks/dogfood-and-measure.md) — `direction`
...
- [R:UNREFUTED and R:REFUTED — a PASS at a plan-or-higher floor needs a refute recorded after the gated run](tasks/refute-gate-rung.md) — `direction` · `standard` · `architecture`
- [add refute — the refute-read becomes a stamp the gate can order, and filled edges join the interview](tasks/refute-verb.md) — `direction` · `standard` · `architecture`
