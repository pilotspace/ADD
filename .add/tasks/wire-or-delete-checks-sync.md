---
type: Task
title: an unreachable writer is wired or deleted, never left tested-but-dead
status: direction
depth: standard
...
beat: scaffold · next: author wire-or-delete-checks-sync's RULES, ASSUMPTIONS and CHECKS, then add freeze wire-or-delete-checks-sync
