---
type: Task
title: the 75 open deltas resolve to folded, rejected or bound
status: direction
depth: quick
...
beat: scaffold · next: author backlog-drain's RULES, ASSUMPTIONS and CHECKS, then add freeze backlog-drain
