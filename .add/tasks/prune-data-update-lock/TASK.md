...
Feature: a home file-lock to serialize concurrent `prune-data` / `update --global` (two `prune-data --force` could race on rmtree) (from global-data-restore spec-delta)
