...
beat: scaffold · next: author ref-resolution-accepts-what-an-operator-types's RULES, ASSUMPTIONS and CHECKS, then add freeze ref-resolution-accepts-what-an-operator-types
