---
type: Task
title: brief is documented as pure and writes a stamp
status: direction
depth: standard
milestone: read-cost
scope:
...
beat: scaffold · next: author brief-is-not-read-only's RULES, ASSUMPTIONS and CHECKS, then add freeze brief-is-not-read-only
