# Payments Milestone 4 — resilient outbound settlement & input hardening

The final hardening of the payments app from Payments Milestone 3. A completed
...
circuit breaker — never hangs, never double-pays. All Payments Milestone 1–3
...
a float), and the Payments Milestone 1–2 malformed cases all return `400`.
