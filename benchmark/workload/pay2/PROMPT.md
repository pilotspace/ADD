# Payments Milestone 2 — pricing & checkout on the ledger

Extend the split-payment ledger from Payments Milestone 1 with a **pricing and
...
every Payments Milestone 1 behavior (accounts, split transfers, reconciliation,
