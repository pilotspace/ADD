"""HV2 must-survive invariants — the pricing LAWS that outlive later evolution.

Re-run against every later HV workspace (hv3 rate limit, hv4 resilient
settlement). KEY-CARRYING (X-API-Key bench-key-alice, pinned in hv3) and kept to
a handful of calls, well under the hv3 bucket. LAW-TOLERANT: probe only pricing
