<!-- meta: The v3.0.0 launch post. HOLD FOR THE FINAL TAG — written and test-bound at beta.2 (tests/book/test_launch_blog.py pins every measured claim to the committed campaign record); publish when v3.0.0 ships. -->
