...
### Spec delta
- [SPEC · dropped] next clean clusters: md5 (trivial) · components (tomllib-guard care) · version-update (_fetch_latest_version PATCHED) · deltas (7 shared constants → constants.py) · release/changelog; THEN cmd_*/save/load/main core (evidence: per-cluster coupling map in memory)
