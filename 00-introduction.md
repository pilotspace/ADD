...
ADD is a development method organized around protecting those three things, because they are now where the difficulty lives.

## The failure mode ADD prevents
...
Speed in the wrong direction is not progress; it is faster waste. The entire purpose of ADD is to fix the direction *before* turning on the speed.
