...
### 0 · design-intake
Before reading the domain, interview the human on **five design axes** so the experience is
*directed*, not guessed — ask each, show options, record the pick:
...
- **INTERACTION** — the experience's *cadence · when/how to seek the human · turn-rhythm*. For a
  gate or interactive UI, this directs the pacing; for a static screen it is *single-shot / none*.
