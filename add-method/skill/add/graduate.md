...
4. **Human confirms** — present the roadmap via `gate-udd.md`, opening with the ARC (goal · done · plan). Render as a guided choice (per `gate-udd.md`). Nothing advances on an unconfirmed draft.
