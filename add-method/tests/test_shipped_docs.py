...
@pytest.mark.xfail(strict=True, reason=(
    "KNOWN DEBT, tracked not hidden: GETTING-STARTED.md still teaches the 2.x flow "
    "(advance · guide · new-task · stage) and is scheduled for rewrite before 3.0.0 final. "
    "strict=True means this FAILS the moment the rewrite lands — forcing the marker off "
    "rather than letting the debt go quietly green."))
