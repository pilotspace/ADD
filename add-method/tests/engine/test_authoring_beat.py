...
def test_no_new_verb_in_the_cli_surface():
    ...
    Re-aimed 23 -> 24 (interview), 24 -> 25 (search), 25 -> 26 (show), 26 -> 27 (drop). The pin is a
    ...
    assert len(list(verbs[0])) == 27, "this task changes what the engine SAYS, never its verb set"
