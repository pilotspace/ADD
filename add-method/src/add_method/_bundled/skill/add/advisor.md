...
<persona>
SELECT the best-fit project persona for this piece — by frontmatter (flow: matching the surface
first, then domain; read one body) — and load `.add/personas/{{PERSONA_SLUG}}.md` —
