...
At spawn, read YOUR phase guides from the project's skill tree (`.claude/skills/add/phases/`): `phases/direction.md` (its Tests span) and `phases/build.md`. They are the method depth for your span; the orchestrator does not pre-read them for you.
