...
At spawn, read YOUR phase guides from the project's skill tree (`.claude/skills/add/phases/`): `phases/1-specify.md` and `phases/3-plan.md` — plus `phases/0-setup.md` on a fresh project. They are the method depth for your span; the orchestrator does not pre-read them for you.
