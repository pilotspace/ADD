...
ENGINE_MD5 = "1c81ca611e23b4f63a57a5538124b3d0"  # re-aimed @ gate-explain (cmd_gate gains --explain: a read-only dry-run naming the gate path AUTO|HUMAN|RELAX|REFUSED + the security floor; outcome arg validated in-body). prior: c760ad74… @ bundle-advance
